<template>
  <div class="flex flex-row justify-between w-5/6">
    <div class="justify-between leading-normal shadow-lg bg-white rounded flex">
      ...
      <img class="h-full max-w-sm" src="https://nuts.com/images/auto/801x534/assets/8ba593eb1bec237d.jpg" alt="Gummy Bears">
      <div></div>
      <div class="w-1/3 flex flex-col p-4">
        <div class="text-indigo-darker font-bold font-sans text-xl mb-2">Gummy Bears</div>
        <p class="text-indigo-darker text-sm font-sans">There’s just something about our 12 flavors of gummy bears! We promise these are superb quality candies you won’t want to put down. Flavors include cherry, pink grapefruit, watermelon, strawberry, orange, blue raspberry, lime, grape, green apple, mango, pineapple and lemon.</p>
      </div>
      <div class="flex flex-col items-center content-center">
        <div class="self-center align-middle ">
          <a href="">
